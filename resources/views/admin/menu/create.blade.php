                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <label>Uri</label>
                                    <input type="text" name="uri" id="uri" value="dashboard/"
                                        oninput="updateValue(this)" class="form-control">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="icon" id="icon" class="form-control"
                                        placeholder="Icon Font Awesome 5">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_has_data_manipulation"
                                        value="YES">
